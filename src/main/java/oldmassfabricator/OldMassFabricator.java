...
@Mod(modid = OldMassFabricator.MODID, name = OldMassFabricator.MODNAME, version = OldMassFabricator.VERSION, dependencies = "required-after:IC2;required-after:ThermalExpansion;after:solidMatter")
public class OldMassFabricator {
    ...
    public void init(FMLInitializationEvent event) {
        ...
        //個体マターを溶かして液体マターへ
        CrucibleManager.addTERecipe(50, new ItemStack(solidMatter, 1), new FluidStack(BlocksItems.getFluid(InternalName.fluidUuMatter), 10));
